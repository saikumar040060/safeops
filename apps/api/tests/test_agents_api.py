...
def test_list_agents_returns_seeded_agents(client):
...
def test_agent_detail_includes_permissions_and_executions(client, seeded_db):
...
def test_agent_detail_unknown_id_returns_404(client):
